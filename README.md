...
🚀 **デモ: https://partner-lingo.vercel.app**(AI呼び出しはコスト保護のため1日30回まで)
...
- **DB**: Turso (libSQL) — 本番はエッジ対応クラウドDB、ローカル開発はファイルDBを同一コードで切り替え
- **ホスティング**: Vercel
...
- [x] Vercel + Turso で本番デプロイ
- [ ] 認証+マルチユーザー対応(現状は共有デモ)
- [ ] 音声メッセージの文字起こし対応
